...
public interface Accionable {
    ...
    public void activarEfecto(Tarro tarro); // Método para aplicar el efecto al tarro
    public TextureRegion obtenerTextura(); // Método para obtener la textura a dibujar
